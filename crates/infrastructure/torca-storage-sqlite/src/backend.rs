...
pub struct MemoryStorageBackend {
    ...
    pending_batches: Vec<&'static str>,
    pending_version: Option<u32>,
}
impl MemoryStorageBackend {
    /// Returns committed SQL batches in order.
    pub fn applied_batches(&self) -> &[&'static str] {
...
impl StorageBackend for MemoryStorageBackend {
    ...
    fn commit(&mut self) -> Result<(), StorageBackendError> {
        ...
        self.applied_batches.append(&mut self.pending_batches);
