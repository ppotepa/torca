...
impl RuntimeHostHandle {
    ...
    pub fn verify_contact(&self, id: ContactId) -> Result<(), RuntimeDriverError> { request(&self.sender, |r| RuntimeCommand::VerifyContact(id, r)) }
    pub fn reset_contact_verification(&self, id: ContactId) -> Result<(), RuntimeDriverError> { request(&self.sender, |r| RuntimeCommand::ResetContactVerification(id, r)) }
