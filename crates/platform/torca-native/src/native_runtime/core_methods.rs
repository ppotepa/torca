...
pub(crate) fn new(event_hub: Arc<RuntimeEventHub>) -> Result<Self, String> {
    ...
    let mut runtime = Self {
        ...
        last_incoming_log_state: None,
        last_rendezvous_log_state: None,
...
pub(crate) fn execute_with_request_id(
    ...
    } = &command
    {
        ...
        // only selected fields were forwarded here and runtime state could
        // drift until a later lifecycle tick or restart.
