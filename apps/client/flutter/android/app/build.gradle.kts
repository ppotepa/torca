...
android {
    ...
    defaultConfig {
        ...
        applicationId = "com.torca.torca_app"
    ...
    buildTypes {
        release {
            ...
            // Rust resolves these methods by their stable JNI names.  Release
            // shrinking must retain the complete Java bridge contract.
            proguardFiles(
