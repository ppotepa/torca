...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => ValueListenableBuilder<AppSnapshotDto>(
        ...
        builder: (BuildContext context, AppSnapshotDto snapshot, Widget? child) => Scaffold(
          appBar: AppBar(
          ...
          body: snapshot.identity == null
              ? _IdentitySetup(gateway: gateway)
              : ListView(
                  children: <Widget>[
                    for (final ConversationDto conversation in snapshot.conversations)
                      ListTile(
                        title: Text('Contact ${conversation.contactId.substring(0, 8)}'),
          ...
          floatingActionButton: snapshot.identity == null
              ...
              : FloatingActionButton(
                  onPressed: () => Navigator.of(context).push<void>(
                    MaterialPageRoute<void>(
                      builder: (BuildContext context) => PairingScreen(gateway: gateway),
                    ),
                  ),
        ...
        child: ConstrainedBox(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              FilledButton(
                onPressed: () => widget.gateway.execute(
