...
class _PairingScreenState extends State<PairingScreen> {
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      if (_mode == _PairingMode.create) ...<Widget>[
                        const Text(
                          'Create a short-lived invitation. The code and expiry are generated by the secure Rust runtime.',
                        ),
  ...
  Future<void> _join() async {
    ...
    final result = await _execute(
      JoinPairingCommandDto(sessionIdHex: _newId(), code: code),
    );
  ...
  Future<void> _session(BridgeCommandDto command) async {
