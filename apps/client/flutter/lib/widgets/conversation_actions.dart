...
abstract final class ConversationActionMenu {
    ...
    required bool blocked,
      ...
      showModalBottomSheet<ConversationAction>(
        ...
        builder: (context) => SafeArea(
          child: Wrap(
            children: _tiles(context, blocked),
          ),
        ),
      );
  ...
  static Future<ConversationAction?> showDesktop(
    ...
    return showMenu<ConversationAction>(
      ...
      items: <PopupMenuEntry<ConversationAction>>[
        ...
        _item(ConversationAction.contactDetails, Icons.person_outline, 'Contact details'),
        _item(ConversationAction.rename, Icons.edit_outlined, 'Rename contact'),
        const PopupMenuDivider(),
        _item(ConversationAction.clearHistory, Icons.delete_sweep_outlined, 'Clear conversation history'),
        _item(
        ...
        const PopupMenuDivider(),
        _item(ConversationAction.remove, Icons.person_remove_outlined, 'Remove contact'),
      ],
    );
  }
  ...
  static List<Widget> _tiles(BuildContext context, bool blocked) => <Widget>[
        ...
        _tile(context, ConversationAction.contactDetails, Icons.person_outline, 'Contact details'),
        _tile(context, ConversationAction.rename, Icons.edit_outlined, 'Rename contact'),
