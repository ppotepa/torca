...
class TorcaLocalizationsUk extends TorcaLocalizations {
  TorcaLocalizationsUk([String locale = 'uk']) : super(locale);
  ...
  @override
  String get chooseNickname => 'Оберіть псевдонім';
  ...
  @override
  String get closeToTray => 'Згортати в системний трей';
  ...
  @override
  String get messageSenderContact => 'Контакт';
