...
class TorcaLocalizationsDe extends TorcaLocalizations {
  TorcaLocalizationsDe([String locale = 'de']) : super(locale);
  ...
  @override
  String get chooseNickname => 'Wähle deinen Spitznamen';
  ...
  @override
  String get closeToTray => 'In den Infobereich schließen';
  ...
  @override
  String get messageSenderYou => 'Du';
  ...
  String sentAt(Object time) {
    return 'Gesendet $time';
  }

  @override
  String deliveredAt(Object time) {
    return 'Zugestellt $time';
  }

  @override
  String seenAt(Object time) {
    return 'Gesehen um $time';
  }
